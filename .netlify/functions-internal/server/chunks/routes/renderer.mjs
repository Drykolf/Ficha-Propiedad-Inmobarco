...
import { f as joinRelativeURL, e as useRuntimeConfig, h as getResponseStatusText, i as getResponseStatus, k as defineRenderHandler, a as getQuery, c as createError, l as getRouteRules, m as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/png","href":"/assets/images/Logo.png"},{"rel":"apple-touch-icon","href":"/assets/images/Logo.png"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"es"},"charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
